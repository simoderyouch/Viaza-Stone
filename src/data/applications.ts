export type ApplicationGroup = 'flooring' | 'interior-walls' | 'facades'
...
export const applicationImages: ApplicationImage[] = [
  ...
  { title: 'Travertine interior wall cladding', group: 'interior-walls', image: projectImage('interior-travertine-wall.jpeg') },
  { title: 'Illuminated travertine wall', group: 'interior-walls', image: projectImage('illuminated-travertine-wall.jpeg') },
  { title: 'Hotel feature wall', group: 'interior-walls', image: projectImage('hotel-feature-wall.jpeg') },
  ...
  { title: 'Travertine exterior cladding', group: 'facades', image: projectImage('travertine-exterior-cladding.jpeg') },
  { title: 'Contemporary stone architecture', group: 'facades', image: projectImage('stone-architecture-facade.png') },
