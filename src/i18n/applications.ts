...
const copy = {
  ...
  fr: {
    ...
    groups: [
      ...
      { id: 'travertine', title: 'Travertin / Volubilis', description: 'Le travertin apporte un mouvement minéral chaleureux et un caractère tactile aux murs intérieurs, éléments hôteliers, habillages extérieurs et architectures monumentales.' },
  ...
  ar: {
    ...
    groups: [
      ...
      { id: 'travertine', title: 'الترافرتين / فولوبيليس', description: 'يمنح الترافرتين حركة معدنية دافئة وطابعًا ملمسيًا للجدران الداخلية والعناصر الفندقية والكسوات الخارجية والعمارة المميزة.' },
